        ...
        scene.on("progress", function (e) {
            requestAnimationFrame(() => {
                ...
                if(p < 0.5){
                    ...
                    let transformPercent = (p - 0.5) * 2;
    
                    if(transformPercent < 0.05){
                        transformPercent = 0;
                    }
                    else if(transformPercent > 0.99){
                        transformPercent = 1.11;
                    }
                    console.log(transformPercent);
                    
                    blackCricle.style.transform = `scale(${transformPercent})`;
                }
                lastProgress = p;
            })
